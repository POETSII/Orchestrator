...
fprintf(fo,"\n==============================================\n");
fprintf(fo,"xmlParser::CDATA() BASE CLASS INSTANCE\n");
...
if (dflag==0) return true;
fprintf(fo,"\n==============================================\n");
fprintf(fo,"xmlParser::Comments() BASE CLASS INSTANCE\n");
fprintf(fo,"Data structure tag     : 0x%#08p\n",p);
...
if (dflag==0) return true;
fprintf(fo,"\n==============================================\n");
fprintf(fo,"xmlParser::EndDocument() BASE CLASS INSTANCE\n");
fprintf(fo,"Data structure tag     : 0x%#08p\n",p);
fprintf(fo,"\n==============================================\n");
fflush(fo);
return true;
...
if (dflag==0) return true;
fprintf(fo,"\n==============================================\n");
fprintf(fo,"xmlParser::EndElement() BASE CLASS INSTANCE\n");
fprintf(fo,"Data structure tag     : 0x%#08p\n",p);
...
bool xmlParser::Error(const void * p,const unsigned & e,const unsigned & r,
...
//fprintf(fo,"xmlParser::Error() BASE CLASS INSTANCE\n");
//fprintf(fo,"Data structure tag     : 0x%#08p\n",p);
fprintf(fo,"Error code             : %u\n",e);
fprintf(fo,".... %2u: %s\n",e,emap[e].c_str());
fprintf(fo,"Row, col               : %u,%u\n",r,c);
...
if (dflag==0) return true;
fprintf(fo,"\n==============================================\n");
fprintf(fo,"xmlParser::JSON() BASE CLASS INSTANCE\n");
fprintf(fo,"Data structure tag     : 0x%#08p\n",p);
...
Lx.SetCFlag(false);                    // And to ignore C-comments
                                       // And away we go...
...
if (dflag==0) return true;
fprintf(fo,"\n==============================================\n");
fprintf(fo,"xmlParser::StartDocument() BASE CLASS INSTANCE\n");
fprintf(fo,"Data structure tag     : 0x%#08p\n",p);
...
if (dflag==0) return true;
fprintf(fo,"\n==============================================\n");
fprintf(fo,"xmlParser::StartElement() BASE CLASS INSTANCE\n");
fprintf(fo,"Data structure tag     : 0x%#08p\n",p);
fprintf(fo,"Element name           : %s\n",s.c_str());
fprintf(fo,"Attributes\n");
if (vps.empty()) fprintf(fo,"   .. there are none\n");
...
string xmlParser::GetString(Lex::Sytype tx)
...
s.erase(s.rfind(Lex::Sytype_str[tx])); // Hoik the token substring off the end
return s;
}
