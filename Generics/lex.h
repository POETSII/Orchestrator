...
Sy_cmnt,Sy_col ,Sy_cmma,Sy_div ,Sy_dol ,Sy_dot ,Sy_dqut,Sy_EOF ,Sy_EOR ,Sy_EQ  ,
Sy_exp ,
...
void          push_back(int = 1);      // Push character back
