...
class OrchBase : public NameBase
{
public:               
...
// tediously this function is needed even if we are only trying to retain the database
// aspect of OrchBase because when the destructor for P_graph is called, it
// then calls UnlinkAll. (Better encapsulation would be appreciated!)
void                   UnlinkAll();
