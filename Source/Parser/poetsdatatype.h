...
public:
    ...
    enum dtype_classes {ISCALAR, FSCALAR, SSCALAR, ARRAY, STRUCT, UNION};

    const QHash<QString, dtype_classes> vld_types = {{"char", ISCALAR}, {"short", ISCALAR}, {"int", ISCALAR}, {"long", ISCALAR}, {"long long", ISCALAR}, {"unsigned char", ISCALAR}, {"unsigned short", ISCALAR}, {"unsigned int", ISCALAR}, {"unsigned long", ISCALAR}, {"unsigned long long", ISCALAR}, {"int8_t", ISCALAR},
                                                            {"int16_t", ISCALAR}, {"int32_t", ISCALAR}, {"int64_t", ISCALAR}, {"uint8_t", ISCALAR}, {"uint16_t", ISCALAR}, {"uint32_t", ISCALAR}, {"uint64_t", ISCALAR},
