...
public:
    ...
    void setDeviceType();
    inline P_device* getDevice() const {return xmlName() == "SDevI" ? supervisor : device;};
    ...
    inline void setPropsDataType(const PIDataType* data_type = 0) {PConcreteInstance::setPropsDataType((xmlName() == "PDevI") || (device_type == NULL) ? NULL : device_type->properties());};
