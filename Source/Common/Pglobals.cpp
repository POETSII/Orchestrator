...
const byte Q::NAME    = 0x0c;
const byte Q::SUPR    = 0x0d;
const byte Q::TINS    = 0x0e;
const byte Q::CANDC   = 0x0f;
const byte Q::QUERY   = 0x10;
const byte Q::APP     = 0x11;
// Level 1 subkeys
...
const byte Q::TOPO    = 0x4b;
const byte Q::DIST    = 0x4c;
const byte Q::RECL    = 0x4d;
const byte Q::TDIR    = 0x4e;
const byte Q::SHOW    = 0x4f;
const byte Q::ACPT    = 0x50;
const byte Q::CLEAR   = 0x51;
const byte Q::DUMP    = 0x52;
const byte Q::MONI    = 0x53;
