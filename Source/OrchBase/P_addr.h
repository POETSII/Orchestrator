...
//==============================================================================
// Class to encapsulate the concept of a device address. The address as such has
// five subfields (Box.Board.Core.Thread.Device), any of which can be valid or
// not at any time (indicated by the int A_???V variable). By and large,
// A_???V == 0 implies that subfield has been set.
// The individual hardware components have a P_addr (with the appropriate
